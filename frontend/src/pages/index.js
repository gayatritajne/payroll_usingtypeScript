  ...
  return (
    <Layout>
          ...
          <div class="carousel-inner">
            ...
            <div class="carousel-item">
              <img
                ...
                src="/account.jpg"
                alt="Second slide" />
              <div class="carousel-caption d-none d-md-block first-slide-carousel-caption">
      ...
      <section id="dms" className="dms-wrapper">
        ...
        <h2 className="text-center pb-3">Welcome to the Payroll Management System</h2>
          <div className="row justify-content-center indexContainerRow">
            
            <div className="col-lg-8 col-md-8 mt-3 ">
              <p>
                The <i>Payroll Management System </i>provides easy access to all the
                important features which are required in Payroll management system anytime anywhere.
              </p>
              <p>
                This system have many features like Upload CTC, Update CTC and to
                upload and view all important documents which are required in
                Payroll system to maintain the employee's record.
              </p>
              <p>
                Morever, here in this system there is provision of role based access.
                Employee can see his/her all information which is related to his/her Salary and Designation.
              </p>
              <p>Owner has his own login for his special rights.</p>
              <p>Both Super admin and HR admin has there own individual accesses depending on their requirement.</p>
            </div>
