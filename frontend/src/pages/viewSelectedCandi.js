...
function App() {
  ...
  const saveOnboardCandi = async (id, candidateName) => {
    //window.alert("Candidate- " + candidateName + " will be Onboard soon")
    toast.success("Candidate " + candidateName + " will be Onboard soon", {
      position: toast.POSITION.TOP_CENTER
  });
