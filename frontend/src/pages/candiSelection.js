...
function App() {
  ...
  const saveApproveCandi = async (id, candidateName) => {
    editCandiStatus(id, { candiStatus: "Selected" })
    getAllCandidates()
    // window.alert("Candidate" + candidateName + " is selected successfully")
    toast.success("Candidate" + candidateName + " is selected successfully", {
      position: toast.POSITION.TOP_CENTER,
    })
    getAllCandidates()
  }
  ...
  const saveHoldCandi = async (id, candidateName) => {
    editCandiStatus(id, { candiStatus: "Hold" })
    getAllCandidates()
    //window.alert("Candidate" + candidateName + " is on hold")
    toast.success("Candidate" + candidateName + " is on hold", {
      position: toast.POSITION.TOP_CENTER,
    })
    getAllCandidates()
  }
